...
namespace TRoseHelper
{
    public static class ObjectHandler
    {
        ...
        public static Player UpdatePlayer()
        {
            ...
            player.Health = Convert.ToInt32(MemoryHandler.ReadMemory((IntPtr)0x007C6710, new int[] { 0x904 }, typeof(int)));
            player.ActionId = Convert.ToInt32(MemoryHandler.ReadMemory((IntPtr)0x007C6710, new int[] { 0x2e }, typeof(int)));
